...
>
  ...
  <xsl:template match="/">
    ...
    <xsl:choose>
      <xsl:when test="mycoreobject/structure/derobjects/derobject and (key('rights', mycoreobject/@ID)/@read or key('rights', mycoreobject/structure/derobjects/derobject/@xlink:href)/@accKeyEnabled)">
        ...
        <div id="mir-collapse-files">
          ...
          <xsl:if test="not(mycoreobject/structure/derobjects/derobject[key('rights', @xlink:href)/@read or key('rights', @xlink:href)/@readKey or key('rights', @xlink:href)/@writeKey])" >
