...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink"
  ...
  xmlns:mcriw="xalan://org.mycore.mir.imageware.MIRImageWarePacker" exclude-result-prefixes="i18n mods xlink xalan mcriw">
      ...
      <dl>
       ...
       -->
        <table class="mir-metadata">
            ...
            <xsl:if test="mycoreobject/service/servdates/servdate/@type='MIR:imageware'">
              <tr>
                <td class="metaname" valign="top">
                  Link zum Volltext:
                </td>
                <td class="metavalue">
                  ...
                  <a href="http://esx-53.gbv.de/test/browser/open/{$ppn}">im MeL öffnen</a>
                </td>
              </tr>
            </xsl:if>
